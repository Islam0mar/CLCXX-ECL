...
template <typename T>
T *unbox_wrapped_ptr(cl_object v) {
...
template <typename T>
void finalizer(cl_object to_delete) {
...
template <typename SourceT, bool compound = false>
...
struct static_type_mapping<void> {
  typedef void type;
  static void lisp_type() {}
};

template <typename NumberT>
struct static_type_mapping<std::complex<NumberT>> {
...
template <>
struct static_type_mapping<cl_object> {
  typedef cl_object type;
...
template <typename CppT>
cl_object box(const CppT &cpp_val) {
  return boxed_cpp_pointer(&cpp_val, static_type_mapping<CppT>::lisp_type(),
                           false);
}

template <>
inline cl_object box(const bool &b) {
  return ecl_make_bool(b);
}

template <>
inline cl_object box(const int32_t &i) {
  return ecl_make_int32_t(i);
}

template <>
inline cl_object box(const int64_t &i) {
  return ecl_make_int64_t(i);
}

template <>
inline cl_object box(const uint32_t &i) {
  return ecl_make_uint32_t(i);
}

template <>
inline cl_object box(const uint64_t &i) {
  return ecl_make_uint64_t(i);
}

template <>
inline cl_object box(const float &x) {
  return ecl_make_single_float(x);
}

template <>
inline cl_object box(const double &x) {
  return ecl_make_double_float(x);
}

template <>
inline cl_object box(const long double &x) {
  return ecl_make_long_float(x);
}

template <>
inline cl_object box(const std::complex<float> &x) {
  return ecl_make_complex(box(std::real(x)), box(std::imag(x)));
}

template <>
inline cl_object box(const std::complex<double> &x) {
  return ecl_make_complex(box(std::real(x)), box(std::imag(x)));
}

template <>
inline cl_object box(const std::complex<long double> &x) {
  return ecl_make_complex(box(std::real(x)), box(std::imag(x)));
}

template <>
inline cl_object box(cl_object const &x) {
  return (cl_object)x;
}

template <>
inline cl_object box(void *const &x) {
  return ecl_make_pointer(x);
}
...
template <>
inline cl_object box(
    const detail::define_if_different<unsigned long, uint64_t> &x) {
  return detail::box_us_long(x);
}

// unbox
template <>
inline bool unbox(cl_object v) {
  return ecl_to_bool(v);
}

template <>
inline float unbox(cl_object v) {
  return ecl_to_float(v);
}

template <>
inline double unbox(cl_object v) {
  return ecl_to_double(v);
}

template <>
inline long double unbox(cl_object v) {
  return ecl_to_long_double(v);
}

template <>
inline std::complex<float> unbox(cl_object v) {
  return std::complex<float>(unbox<float>(cl_realpart(v)),
                             unbox<float>(cl_imagpart(v)));
}

template <>
inline std::complex<double> unbox(cl_object v) {
  return std::complex<double>(unbox<double>(cl_realpart(v)),
                              unbox<double>(cl_imagpart(v)));
}

template <>
inline std::complex<long double> unbox(cl_object v) {
  return std::complex<long double>(unbox<long double>(cl_realpart(v)),
                                   unbox<long double>(cl_imagpart(v)));
}

template <>
inline int32_t unbox(cl_object v) {
  return ecl_to_int32_t(v);
}

template <>
inline int64_t unbox(cl_object v) {
  return ecl_to_int64_t(v);
}

template <>
inline uint32_t unbox(cl_object v) {
  return ecl_to_uint32_t(v);
}

template <>
inline uint64_t unbox(cl_object v) {
  return ecl_to_uint64_t(v);
}

template <>
inline void *unbox(cl_object v) {
  return ecl_to_pointer(v);
}

template <typename T>
struct IsFundamental {
  T operator()() const {
    return (std::is_fundamental<T>::value || std::is_void<T>::value ||
...
template <typename T>
struct ConvertToLisp<T, true> {
  cl_object operator()(T cpp_val) const { return box<T>(cpp_val); }
};

template <>
struct ConvertToLisp<std::string, false> {
  cl_object operator()(const std::string &str) const {
    return ecl_make_constant_base_string(str.c_str(), str.length());
  }
};
...
template <>
struct ConvertToLisp<const std::string *, false> {
  cl_object operator()(const std::string *str) const {
    return ConvertToLisp<std::string, false>()(*str);
  }
};
...
template <>
struct ConvertToLisp<const char *, false> {
  cl_object operator()(const char *str) const {
    return ecl_make_constant_base_string(str, strlen(str));
  }
};
...
template <>
struct ConvertToLisp<cl_object, false> {
